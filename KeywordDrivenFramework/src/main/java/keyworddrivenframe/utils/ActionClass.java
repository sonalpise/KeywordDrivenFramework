package keyworddrivenframe.utils;
...
public class ActionClass {
	...
	public static void invokeMethod(String className, String methodName,
		...
		try {
			...
			Object _instance = actionClass.getDeclaredConstructor().newInstance();
	...
	public  boolean run(WebDriver driver,String fileName,String sheetName) throws Exception{
		...
		for (row=1; row <=rowCount; row++) {
			...
			invokeMethod("keyworddrivenframe.utils.ActionClass",methodName, paramsArray);
		}
		result = true;
		return result;
	}
